...
class CartStatsAPIView(generics.RetrieveAPIView):
    ...
    def get(self, request, *args, **kwargs):
        totals = self.get_queryset().aggregate(
            ...
            total_tax=Sum('tax_fee'),
            total_total=Sum(F('price') + F('tax_fee'), output_field=DecimalField())
        )

        data = {
            "price": totals['total_price'] or 0,  # If no value, return 0
            "tax": totals['total_tax'] or 0,      # If no value, return 0
            "total": totals['total_total'] or 0,  # If no value, return 0
        }
...
class CreateOrderAPIView(generics.CreateAPIView):
    ...
    # def create(self, request, *args, **kwargs):
    #     # Request data will automatically be validated by the serializer
    #     serializer = self.get_serializer(data=request.data)

    #     if serializer.is_valid():
    #         # The serializer will handle creating the order and related items
